    ...
    variants: {
      variant: {
        ...
        success: // Added success variant
          "success group border-accent bg-accent text-accent-foreground", // Use accent colors
      },
    },
    defaultVariants: {
      variant: "default",
