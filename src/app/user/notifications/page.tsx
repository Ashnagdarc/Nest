...
// Mock Data - Replace with actual fetched notifications for the user
const mockNotifications = [
  { id: 'un1', type: 'request_approved', content: 'Your request for Canon EOS R5 has been approved.', timestamp: new Date(Date.now() - 1000 * 60 * 15), read: false, link: '/user/my-requests' },
  { id: 'un2', type: 'request_rejected', content: 'Your request for DJI Mavic 3 was rejected. Reason: Requires maintenance.', timestamp: new Date(Date.now() - 1000 * 60 * 90), read: false, link: '/user/my-requests' },
  { id: 'un3', type: 'gear_due_soon', content: 'Reminder: Manfrotto Tripod is due tomorrow.', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 20), read: true, link: '/user/check-in' },
  { id: 'un4', type: 'new_announcement', content: 'Admin posted a new announcement: Office Maintenance Schedule', timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24 * 2), read: true, link: '/user/dashboard' }, // Link could go to announcements page if exists
];
