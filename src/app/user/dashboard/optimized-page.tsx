// Optimized User Dashboard - Uses centralized data fetching for better performance
...
import { OptimizedUpcomingEvents } from "@/components/dashboard/OptimizedUpcomingEvents";
import { OptimizedRecentActivity } from "@/components/dashboard/OptimizedRecentActivity";
import { OptimizedPopularGearWidget } from "@/components/dashboard/OptimizedPopularGearWidget";
...
/**
 * Optimized user dashboard component with centralized data management.
 * Significantly reduces API calls and improves loading performance.
 */
export default function OptimizedUserDashboardPage() {
    ...
    // Transform dashboard data into the format expected by the UI
    const userStats = [
        {
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8 space-y-6 sm:space-y-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 sm:gap-8">
                    ...
                    <div className="space-y-6 sm:space-y-8">
                        <OptimizedUpcomingEvents
                            events={dashboardData.events}
                            gearDetails={dashboardData.gearDetails}
                            loading={dashboardData.loading.events}
                        />
                        <OptimizedPopularGearWidget
                            popularGear={dashboardData.popularGear}
                            gearDetails={dashboardData.gearDetails}
                            loading={dashboardData.loading.popularGear}
                        />
                    </div>
                                ...
                                <div className="grid grid-cols-1 divide-y">
                                    <div className="p-4 sm:p-6">
                                        ...
                                        <OptimizedRecentActivity
                                            ...
                                            gearDetails={dashboardData.gearDetails}
                                            loading={dashboardData.loading.activities}
                                            embedded={true}
                                        />
                                    </div>
                                    <div className="p-4 sm:p-6">
